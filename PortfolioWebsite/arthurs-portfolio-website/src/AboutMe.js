...
function About() {
    ...
    return (
        <div className="AboutMe" id="AboutMe">
            ...
            <div className="personalSkills" data-aos="fade-left" data-aos-delay={500}>
